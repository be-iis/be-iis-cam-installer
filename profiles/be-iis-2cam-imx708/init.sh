...
#
# This reproduces the known working state from 2026-07-25. Together with the
# included IMX708 horizontal-blanking patch, RP1-CFE receives clean
# 2304x1296 RAW10 buffers.
#
# Usage:
...
#   I2C_BUS=11 DES_ADDR=0x28 SER_ADDR=0x40 POT_ADDR=0x51
...
configure_link()
{
	...
	log "Configuring DigiPot channel B for the known 6-Gbit coax setting"
	i2ctransfer -f -y "$I2C_BUS" \
		"w2@${POT_ADDR}" 0x01 0xae
